...
print(f"The loan total is : ${sum(loan_costs)}.")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
average_loan_amount = sum(loan_costs)/len(loan_costs)
print(f"The average loan amount in the list is: {average_loan_amount}.")
...
if present_value >= loan_cost:
    print("The loan is worth it the cost to buy it!")
else:
